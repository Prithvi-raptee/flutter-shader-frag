...
// Declare the output variable for the final pixel color
out vec4 fragColor;
...
void main()
{
    ...
    finalColor *= (brightness + (0.5+ u_intensity));

    // Assign the final computed color to our declared output variable
